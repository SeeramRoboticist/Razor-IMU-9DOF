...
float ACCEL_X_MIN = -251;
float ACCEL_X_MAX = 265;
float ACCEL_Y_MIN = -257.08;
float ACCEL_Y_MAX = 269.41;
float ACCEL_Z_MIN = -253;
float ACCEL_Z_MAX = 262.94;
...
float magn_ellipsoid_center[3] = {830.497, 932.630, 181.838};
float magn_ellipsoid_transform[3][3] = {{0.940314, 0.0498673, 0.0290085}, {0.0498673, 0.958215, -0.0278537}, {0.0290085, -0.0278537, 0.878123}};
// Gyroscope
